Pod::Spec.new do |spec|
  ...
  spec.name         = "AliUltronSDK"
  spec.version      = "0.0.5"
  spec.summary      = "AliUltronSDK."
  ...
  # 阿里云发布约定
  spec.source               = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/cr-halo-ultron/0.0.5/cr-halo-ultron.zip"}
  spec.requires_arc = true

  spec.vendored_framework   = 'cf-halo-ultron/AliUltronSDK.framework'  
