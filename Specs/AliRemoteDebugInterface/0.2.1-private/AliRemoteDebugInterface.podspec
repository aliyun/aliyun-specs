Pod::Spec.new do |s|
  ...
  s.version      = "0.2.1-private"
  s.platform     = :ios
  s.summary      = "AliRemoteDebugInterface SDK for iOS."
  s.homepage     = "https://www.aliyun.com"
  s.author       = { "jiangzheng" => "stephen.sj@alibaba-inc.com" }
  s.source       = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/emas-aliremotedebuginterface/0.2.1-private/emas-aliremotedebuginterface.zip" }
