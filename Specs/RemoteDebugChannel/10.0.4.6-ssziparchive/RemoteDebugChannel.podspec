Pod::Spec.new do |s|
  ...
  s.version      = "10.0.4.6-ssziparchive"
  s.platform     = :ios 
  s.summary      = "RemoteDebugChannel SDK for iOS."
  s.homepage     = "https://www.aliyun.com"
  s.author       = { "jiangzheng" => "stephen.sj@alibaba-inc.com" }
  s.source = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/emas-remotedebugchannel/10.0.4.6-ssziparchive/emas-remotedebugchannel.zip" }
