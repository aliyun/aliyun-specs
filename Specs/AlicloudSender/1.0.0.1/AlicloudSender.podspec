Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/emas-active/1.0.0.1/emas-active.zip" }
  s.vendored_frameworks = "emas-alicloudsender/AlicloudSender.framework"
