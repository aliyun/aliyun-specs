Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "8.0"
  s.source       = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/emas-fbretaincycledetector/0.1.4.4/emas-fbretaincycledetector.zip" }
  s.library = 'c++'
  s.vendored_frameworks = 'emas-fbretaincycledetector/FBRetainCycleDetector.xcframework'
