Pod::Spec.new do |s|
  ...
  s.version               = "3.4.1.7-ilop"
  s.summary               = "ALBBOpenAccount"
  s.license               = { :type => 'Copyright', :text => "Alibaba-INC copyright" }
  s.author                = { "佑贤" => "azad.ljj@alibaba-inc.com" }
  s.source                = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/iot-AliyunIotALBBOpenAccount/3.4.1.7-ilop/iot-AliyunIotALBBOpenAccount.zip" }
  s.requires_arc          = true
  s.platform     = :ios, '8.0'
