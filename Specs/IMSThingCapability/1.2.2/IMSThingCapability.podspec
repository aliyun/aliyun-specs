Pod::Spec.new do |s|
  ...
  s.source                = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/ims_thing_capability/1.2.2/ims_thing_capability.zip" }
  s.platform              = :ios, '8.0'
  ...
  s.dependency 'IMSMobileChannel', '1.2.0'
  s.dependency 'AlicloudSGMain', '5.3.78' #新增安全保镖依赖
  s.dependency 'IMLCoapBase', '1.2.2' # 本地通信通道
