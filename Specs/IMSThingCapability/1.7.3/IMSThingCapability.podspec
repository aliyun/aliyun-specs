Pod::Spec.new do |s|
  ...
  s.source                = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/ims_thing_capability/1.7.3/ims_thing_capability.zip" }
  s.platform              = :ios, '8.0'
