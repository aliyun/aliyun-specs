Pod::Spec.new do |s|
  ...
  s.source                = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/ims_thing_capability/1.7.2/ims_thing_capability.zip" }
  s.platform              = :ios, '8.0'
  ...
  s.dependency 'IMSMobileChannel', '1.6.2.1'
  s.dependency 'AlicloudSGMain', '5.4.101' #新增安全保镖依赖
  s.dependency 'IMLCoapBase', '1.6.5' # 本地通信通道
  s.dependency 'IMSDeviceGateway', '1.6.2.1' # 本地通信通道
