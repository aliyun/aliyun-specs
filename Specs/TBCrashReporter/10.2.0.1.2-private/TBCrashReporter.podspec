Pod::Spec.new do |s|
  ...
  s.version      = "10.2.0.1.2-private"
  s.platform     = :ios
  s.ios.deployment_target = "12.0" 
  s.summary      = "TBCrashReporter SDK for iOS."
  s.homepage     = "https://www.aliyun.com"
  s.author       = { "xiangji" => "xiangji.bxj@alibaba-inc.com" }
  s.source       = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/emas-tbcrashreporter/10.2.0.1.2-private/emas-tbcrashreporter.zip" }
  s.libraries    = 'c++'
