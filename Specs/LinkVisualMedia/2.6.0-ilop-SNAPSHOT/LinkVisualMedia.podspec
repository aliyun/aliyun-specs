Pod::Spec.new do |s|
  ...
  s.version               = "2.6.0-ilop-SNAPSHOT"
  s.summary               = "阿里云IoT物联网视频SDK"
  s.homepage              = "https://www.aliyun.com/"
  s.license               = { :type => 'Copyright', :text => "Alibaba-INC copyright" }
  s.author                = { "EverettLi" => "everettli.ll@alibaba-inc.com" }
  s.source                = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/ims_linkvisual_media/2.6.0-ilop-SNAPSHOT/ims_linkvisual_media.zip" }
  s.platform              = :ios, '9.0'
