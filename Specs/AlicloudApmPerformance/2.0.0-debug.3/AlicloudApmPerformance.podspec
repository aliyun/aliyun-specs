Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '10.0'
  s.source       = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/AlicloudApmPerformance/2.0.0-debug.3/AlicloudApmPerformance.zip" }
  s.vendored_frameworks = 'AlicloudApmPerformance/AlicloudApmPerformance.xcframework'

  s.libraries = ['c++']

  s.dependency 'AlicloudApmCore', '~> 1.2.0'
  s.dependency 'AlicloudAPM',     '1.2.4-debug.3'
