Pod::Spec.new do |s|
  ...
  s.source                = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/ims-iot-smart/1.0.1/ims-iot-smart.zip" }
  s.platform              = :ios, '8.0'
  s.vendored_frameworks = 'IMSIotSmart/IMSIotSmart.framework'
  s.resources = 'IMSIotSmart/IMSIotSmart.framework/IMSIotSmart.bundle'
