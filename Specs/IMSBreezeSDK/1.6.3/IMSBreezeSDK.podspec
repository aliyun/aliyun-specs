Pod::Spec.new do |s|
  ...
  s.source                = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/ims_breeze_sdk/1.6.3/ims_breeze_sdk.zip" }
  s.platform              = :ios, '8.0'
  ...
  s.dependency 'LinkNetworkSDK', '1.0.2.1'
  s.dependency 'IMSDeviceGateway', '1.6.2.1'
end
