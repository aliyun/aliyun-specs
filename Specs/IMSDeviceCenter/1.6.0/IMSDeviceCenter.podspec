Pod::Spec.new do |s|
  ...
  s.source                = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/ims_device_center/1.6.0/ims_device_center.zip" }
  s.platform              = :ios, '8.0'
  ...
  s.dependency 'IMLCoapBase', '1.6.0'
  s.dependency 'LinkNetworkSDK', '1.0.1'
