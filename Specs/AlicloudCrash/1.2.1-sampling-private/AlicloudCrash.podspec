Pod::Spec.new do |s|
  ...
  s.version          = '1.2.1-sampling-private'
  s.platform         = :ios 
  s.ios.deployment_target = "12.0"
  s.summary          = 'Aliyun Mobile Service AlicloudCrash iOS SDK.'
  s.homepage         = 'https://www.aliyun.com'
  s.author           = { 'xiangji' => 'xiangji.bxj@alibaba-inc.com' }
  s.source           = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/emas-alicloudcrash/1.2.1-sampling-private/emas-alicloudcrash.zip" }
