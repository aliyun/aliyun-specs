Pod::Spec.new do |s|
  ...
  s.version      = "10.0.3-private"
  s.platform     = :ios 
  s.ios.deployment_target = '12.0'
  s.summary      = "BizErrorReporter4iOS SDK for iOS."
  s.homepage     = "https://www.aliyun.com"
  s.author       = { "jiangzheng" => "stephen.sj@alibaba-inc.com" }
  s.source       = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/emas-bizerrorreporter4ios/10.0.3-private/emas-bizerrorreporter4ios.zip" }
