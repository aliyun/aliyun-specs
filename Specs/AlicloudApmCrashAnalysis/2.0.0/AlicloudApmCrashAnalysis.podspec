Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '10.0'
  s.source       = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/AlicloudApmCrashAnalysis/2.0.0/AlicloudApmCrashAnalysis.zip" }
  s.vendored_frameworks = 'AlicloudApmCrashAnalysis/AlicloudApmCrashAnalysis.xcframework'

  s.libraries = ['c++']

  s.dependency 'AlicloudApmCore', '1.0.0'
