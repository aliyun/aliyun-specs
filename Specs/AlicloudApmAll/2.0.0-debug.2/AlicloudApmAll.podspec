Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '10.0'
  s.source       = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/AlicloudApmAll/2.0.0-debug.2/AlicloudApmAll.zip" }
  s.vendored_frameworks = 'AlicloudApmAll/AlicloudApmAll.xcframework'

  s.dependency 'AlicloudApmCrashAnalysis', '~> 2.2.0'
  s.dependency 'AlicloudApmPerformance',   '~> 2.0.0-debug.2'
