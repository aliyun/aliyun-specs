Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '10.0'
  s.source       = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/AlicloudApmAll/2.2.2/AlicloudApmAll.zip" }
  s.vendored_frameworks = 'AlicloudApmAll/AlicloudApmAll.xcframework'
  s.swift_version = '5.9'
  s.static_framework = true

  s.dependency 'AlicloudApmCore', '~> 1.4.1'
  s.dependency 'AlicloudApmCrashAnalysis', '~> 2.3.9'
