Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '10.0'
  s.source       = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/AlicloudApmAll/2.1.10/AlicloudApmAll.zip" }
  s.vendored_frameworks = 'AlicloudApmAll/AlicloudApmAll.xcframework'
  s.swift_version = '5.9'
  s.static_framework = true

  
  s.dependency 'AlicloudApmCrashAnalysis', '~> 2.3.7'
  ...
  s.subspec "AlicloudApmRemoteLog" do |ss|
    ...
    ss.dependency 'AlicloudApmCore', '~> 1.3.11'
