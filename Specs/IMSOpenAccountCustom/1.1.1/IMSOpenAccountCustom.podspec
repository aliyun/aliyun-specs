Pod::Spec.new do |s|
  ...
  s.source                = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/ims_openaccount_custom/1.1.1/ims_openaccount_custom.zip" }
  s.platform              = :ios, '8.0'
  ...
  s.dependency  'AlicloudALBBOpenAccount' , '3.4.0.32-ilop'
end