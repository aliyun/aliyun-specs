...
Pod::Spec.new do |spec|
    ...
    spec.name         = "ARMHaloFloorContainer"
    spec.version      = "0.0.3"
    spec.summary      = "A short description of ARMHaloFloorContainer."
    ...
    # 阿里云发布约定
    spec.source               = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/cr-halo-container/0.0.4/cr-halo-container.zip"}
  ...
  #   spec.resources            = "v3.0/Resource/*.*"
    ...
    spec.vendored_framework   = 'cr-halo-container/ARMHaloFloorContainer.framework'
