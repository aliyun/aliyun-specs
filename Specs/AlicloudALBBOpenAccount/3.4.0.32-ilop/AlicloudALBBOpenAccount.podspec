Pod::Spec.new do |s|
  ...
  s.source                = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/openaccount/3.4.0.32-ilop/openaccount.zip" }
  s.version               = "3.4.0.32-ilop"
  ...
  s.dependency  'AlicloudSGSecurityBody', '5.4.70'
