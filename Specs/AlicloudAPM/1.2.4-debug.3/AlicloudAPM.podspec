Pod::Spec.new do |s|
  s.name             = 'AlicloudAPM'
  s.version          = '1.2.4-debug.3'
  s.platform         = :ios
  s.ios.deployment_target = "10.0"
  s.summary          = 'Aliyun Mobile Service AlicloudAPM iOS SDK.'
  s.homepage         = 'https://www.aliyun.com'
  s.author           = { 'xiangji' => 'xiangji.bxj@alibaba-inc.com' }
  s.source           = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/emas-alicloudapm/1.2.4-debug.3/emas-alicloudapm.zip" }
  ...
  s.dependency  'AliCloudNetworkMonitor', '2.0.3-debug.3'
