Pod::Spec.new do |s|
	...
	s.platform     =  :ios, '8.0'
	s.source = { :http => 'https://ios-repo.oss-cn-shanghai.aliyuncs.com/iot-alinkdevicecenter/1.0.1/iot-alinkdevicecenter.zip' }
        s.vendored_frameworks = 'iot-alinkdevicecenter/*.framework'	                      

	s.dependency 'AlinkSDK', '1.0.3'
	s.dependency 'AKTBJSONModel', '1.0.0'
    s.dependency 'AKDeviceKit', '1.0.2'
