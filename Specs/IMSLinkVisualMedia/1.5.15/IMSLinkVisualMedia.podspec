Pod::Spec.new do |s|
  ...
  s.version               = "1.5.15"
  s.summary               = "基于LinkVisual提供的播放器"
  s.homepage              = "https://www.aliyun.com/"
  s.license               = { :type => 'Copyright', :text => "Alibaba-INC copyright" }
  s.author                = { "EverettLi" => "xxx" }
  s.source                = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/ims_linkvisual_media/1.5.15/ims_linkvisual_media.zip" }
  s.platform              = :ios, '9.0'
