Pod::Spec.new do |s|
  s.name         = "AlicloudHA"
  s.version      = "1.0.1.1-SNAPSHOT"
  s.platform     = :ios 
  s.summary      = "Aliyun Mobile HA SDK for iOS."
  s.homepage     = "https://www.aliyun.com"
  s.author       = { "xiangji" => "xiangji.bxj@alibaba-inc.com" }
  s.source       = { :http => "https://ios-repo.oss-cn-shanghai.aliyuncs.com/ha_crash_analysis/1.0.1.1-SNAPSHOT/ha_crash_analysis.zip" }
  s.vendored_frameworks = 'ha_crash_analysis/AliHAAdapter4Cloud.framework'
  s.dependency   "TBCrashReporter", '=10.0.3.1'
